...
onExpandChange(id: number, checked: boolean): void {
 ...
 generateCSV() {
  ...
  const headers = ['','FIRST NAME', 'MIDDLE NAME', 'LAST NAME', 'USERNAME', 'PASSWORD', 'EMAIL', 'NUMBER', 'POSITION', 'DEPARTMENT','DATE EMPLOYMENT', 'STATUS', 'ROLE','CURRENT LEAVE APPLY'];
  ...
  var title = this.papa.unparse({
    "fields": ["Employee Record List","        ","        ","        ","        ","        ","        ","        ","        ","        ","        ","        ","Total Current Employee : ",this.employee_count],
    "data": [
...
generatePDF() {
  ...
  doc.setFontSize(16);
  doc.text("Employee Record", 10, 10);
  ...
  // Set the table headers
  const headers = ['', 'First Name', 'Middle Name', 'Last Name', 'Username', 'Password', 'Email', 'Number', 'Position', 'Department','Date Employment', 'Status', 'Role'];
